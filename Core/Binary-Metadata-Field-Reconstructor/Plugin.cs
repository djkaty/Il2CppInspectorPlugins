...
namespace Il2CppInspector.Plugins.Core
{
    ...
    public class ReconstructMetadataPlugin : ICorePlugin, ILoadPipeline
    {
        // Plugin definition
        public string Id => "reconstruct-metadata";
        public string Name => "Binary metadata field order deobfuscator";
        public string Author => "Il2CppInspector";
        public string Version => "2021.1.0";
        public string Description => "Automatic detection and deobfuscation of reordered fields in Il2CppCodeRegistration and Il2CppMetadataRegistration";
        public List<IPluginOption> Options => null;

        // Items we are currently processing (surrogate properties)
        private Il2CppBinary Binary;
        private Metadata Metadata => Binary.Metadata;
        private IFileFormatStream Image => Binary.Image;
        private Il2CppCodeRegistration CodeRegistration => Binary.CodeRegistration;
        private Il2CppMetadataRegistration MetadataRegistration => Binary.MetadataRegistration;
...
#region Debugging validation checks
        ...
        if (fieldOffsets.count != MetadataRegistration.fieldOffsetsCount)
            ...
            Image.WriteObject(Image.MapVATR(binary.CodeRegistrationPointer), CodeRegistration);
            Image.WriteObject(Image.MapVATR(binary.MetadataRegistrationPointer), MetadataRegistration);
